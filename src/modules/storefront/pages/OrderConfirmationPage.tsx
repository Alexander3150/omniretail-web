...
export function OrderConfirmationPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-14">
      <section className="overflow-hidden rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-xl shadow-[var(--color-title)]/10">
        <div className="bg-[var(--color-topbar)] px-7 py-8 text-white">
          <p className="text-sm font-bold uppercase tracking-[.18em] text-[var(--color-primary)]">
            {paymentApproved ? "Pago aprobado" : "Pedido creado"}
          </p>
          <h1 className="mt-3 text-4xl font-black">Gracias por tu compra</h1>
        ...
        <div className="p-7">
          <div className="grid gap-4 rounded-2xl bg-[var(--color-app-background)] p-5 sm:grid-cols-2">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[var(--color-text-muted)]">
                Número de pedido
              </p>
              <p className="mt-1 text-lg font-black text-[var(--color-text)]">{orderNumber}</p>
            </div>
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[var(--color-text-muted)]">
                Total
              </p>
              <p className="mt-1 text-lg font-black text-[var(--color-title)]">
